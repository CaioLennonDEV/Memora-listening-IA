...
| spawns-over | infra | `valkey/valkey:8-alpine` · `postgres:17-alpine` · `quay.io/minio/minio` + `quay.io/minio/mc` | the backing stores every service `depends_on: service_healthy` |
