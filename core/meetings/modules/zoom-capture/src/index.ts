 ...
 */
export { createZoomSpeakers, rosterFromZoomTiles, scanZoomNameTiles, normalizeZoomDisplayName } from './zoom-speakers.js';
export type { ZoomSpeakers, ZoomSpeakersOptions, ZoomRosterPerson, ZoomRosterSnapshot } from './zoom-speakers.js';
