...
MEETING_DOC_PROMPT = (
    ...
    "date: {date}\n"
    "---\n\n"
    "After the frontmatter, write a complete, professional executive summary of the meeting in the primary language "
    "of the discussion (Portuguese if spoken in Portuguese, otherwise English). Then include the structured sections:\n"
    "## Attendees\n"
    "(list of participants present, with `[[wikilinks]]`)\n\n"
    "## Summary\n"
    "(concise executive summary of what was discussed, context, and key observations)\n\n"
    "## Topics\n"
    "(main topics and discussion points)\n\n"
    "## Decisions\n"
    "(list of decisions and commitments made)\n\n"
    "## Actions\n"
    "(list of action items formatted as `- [ ] Task description — owner: [[Name]]`)\n\n"
    "Here are the entities and signals surfaced during the meeting (JSON):\n\n{cards}\n\n"
    "Do NOT copy the raw transcript verbatim. When done, write/edit ONLY that one file."
)
