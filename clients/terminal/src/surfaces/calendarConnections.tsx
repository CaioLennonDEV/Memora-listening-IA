  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 7, borderTop: "1px dashed var(--line)", paddingTop: 9 }}>
      ...
      <label style={labelled}>
        ...
        <input value={botName} onChange={(e) => setBotName(e.target.value)} maxLength={100} placeholder="Memora"
  ...
  return (
    <div style={{ ...row, opacity: cal.enabled ? 1 : 0.7 }}>
      ...
      <div style={{ display: "flex", gap: 18, flexWrap: "wrap" }}>
        ...
        <span style={meta}>Bot name <span style={{ color: "var(--t2)", fontFamily: "var(--mono)" }}>{cal.bot_name || "Memora"}</span></span>
      </div>
